			...
			return Backbone.View
					.extend({
						...
						save : function() {
							...
							this.$el.find('.schedule-div:not(:last-child)').each(function(index){
								...
								objScheduleModel.set('title',that.$el.find('#txttitle').val());
								...
								objScheduleModel.set('branchid',that.branchid);
								   if (index === total - 1) {
									   objScheduleModel.set('last','1'); 
								    }else{
								    	  objScheduleModel.set('last','0'); 
								    }
